...
// ///==================================step4(npm i firebase-admin-import)======================================================
// // https://firebase.google.com/docs/storage/admin/start
// ///go to firebase(seting-> project->service account-> generate key )
// var serviceAccount ={
//     "type": "service_account",
//     "project_id": "mycrudapp-2ced8",
//     "private_key_id": "e275436eb480aa2abccb0532e3fbe5f56bc4e8c8",
...
// })
// var upload = multer({ storage: storageConfig })
// //==============================================step2// const userSchema = new mongoose.Schema({
...
//         app.post("/signup", upload.any(), (req, res) => {  ////step3 app.post
...
//         /////commint this validation return n tn chek 

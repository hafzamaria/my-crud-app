     ...
     <div className='result'>
      <div className='map1'>
          ...
          {products.map(eachProduct => (
            ...
            <div className='img1'>  <img className='pic'  src={eachProduct.profilePicture} alt="" /></div>
           <div className='detail'>
             <p className='name1'>{eachProduct.name}</p><br/>
              <div  >{eachProduct.description}</div><br/>
              <div className='price' >{eachProduct.Price}</div><br/>
              <div >{eachProduct.code}</div><br/>
</div>
              </div>
